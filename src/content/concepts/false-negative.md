---
title: "假阴性"
description: "假阴性发生在一个人实际具有目标状态，但筛查或测验没有识别出来。心理健康场景中，假阴性可能导致延迟求助、低估风险或错过早期干预。"
plainDefinition: "假阴性是指实际存在某种问题或风险，但测验或筛查结果显示为阴性。"
group: "心理治疗与评估"
...
related: ["sensitivity", "negative-predictive-value", "screening", "clinical-cutoff"]
pubDate: 2026-06-08
tags: ["假阴性", "漏报", "筛查"]
sourceRefs:
...
假阴性发生在一个人实际具有目标状态，但筛查或测验没有识别出来。心理健康场景中，假阴性可能导致延迟求助、低估风险或错过早期干预。
...
理解假阴性可以提醒读者：量表结果正常不等于绝对没有问题，尤其当痛苦和功能损害已经明显时。
