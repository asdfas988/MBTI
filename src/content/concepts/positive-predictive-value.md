---
title: "阳性预测值"
description: "阳性预测值受敏感度、特异度和基准率共同影响。即使一个工具看似准确，在目标问题本来很少见的人群中，阳性结果仍可能有相当比例是假阳性。"
plainDefinition: "阳性预测值表示测试阳性者中真正具有目标问题的比例。"
group: "心理治疗与评估"
...
related: ["sensitivity", "specificity", "base-rate", "false-positive"]
pubDate: 2026-06-08
tags: ["阳性预测值", "PPV", "测量"]
sourceRefs:
...
阳性预测值受敏感度、特异度和基准率共同影响。即使一个工具看似准确，在目标问题本来很少见的人群中，阳性结果仍可能有相当比例是假阳性。
...
它是解释心理筛查结果最容易被忽略的概念，能帮助读者理解“测出来有风险”与“确定有诊断”之间的距离。
