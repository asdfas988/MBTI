---
title: "反应偏差"
description: "答案不只反映我，也反映我怎么面对测试。它属于心理测量和评估语言，用来帮助读者更谨慎地解释分数、误差和适用范围。"
plainDefinition: "答案不只反映我，也反映我怎么面对测试。"
group: "心理治疗与评估"
english: "Response Bias"
aliases: []
domains: ["心理测量", "作答"]
level: "基础"
clinicalBoundary: "本站把它作为心理测量与评估概念使用。任何测验分数都不能脱离测验目的、样本、信度效度证据、文化背景和合格专业解释单独下结论。"
related: ["social-desirability-bias", "validity", "personality-test", "clinical-interview"]
pubDate: 2026-06-08
tags: ["反应偏差", "作答偏差", "测验"]
sourceRefs:
...
反应偏差（Response Bias）指答案不只反映我，也反映我怎么面对测试。

## 概念边界

反应偏差是心理测量和评估中的概念，必须放在测验目的、样本、常模、信度效度、公平性和解释责任中理解。它不能单独证明一个人“是什么样的人”。

## 为什么重要

它能帮助读者避免把分数当成绝对事实。无论是人格测验、筛查量表还是疗效监测，反应偏差都提醒我们：测量是有误差、有边界、有适用条件的。
...
反应偏差在人格网站中承担“防误读”的功能。它提醒读者，测验结果会进入自我叙事，因此解释时要保护人的复杂性，避免把暂时状态、文化差异或量表误差人格化。
