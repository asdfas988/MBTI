---
title: "敏感度"
description: "敏感度描述一个工具在确有目标状态的人群中给出阳性结果的比例。敏感度低时，假阴性会增加，真实需要关注的人可能被漏掉。"
plainDefinition: "敏感度是筛查或测验正确识别“确有目标问题”的人的能力。"
group: "心理治疗与评估"
english: "Sensitivity"
aliases: []
domains: ["心理测量", "筛查"]
...
related: ["screening", "specificity", "false-negative", "positive-predictive-value"]
pubDate: 2026-06-08
tags: ["敏感度", "筛查", "测量"]
sourceRefs:
...
敏感度描述一个工具在确有目标状态的人群中给出阳性结果的比例。敏感度低时，假阴性会增加，真实需要关注的人可能被漏掉。
...
敏感度是理解心理筛查、风险识别和早期干预的重要概念，尤其适合与特异度、基准率和预测值一起阅读。
