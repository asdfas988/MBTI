---
title: "混乱型依恋"
description: "混乱型依恋常表现为靠近和害怕并存、行为无组织、冻结、突然切换或难以形成稳定求助策略。它常与惊吓性照护、创伤和严重关系不一致有关。"
plainDefinition: "混乱型依恋是依恋对象同时被体验为安全来源和威胁来源时形成的矛盾策略。"
group: "关系与依恋"
english: "Disorganized Attachment"
aliases: ["恐惧-回避型依恋"]
domains: ["关系与依恋"]
level: "进阶"
clinicalBoundary: "本站把它作为依恋与关系调节概念使用，不把单个关系反应固定成终身类型。依恋表现会随关系、创伤、文化和治疗经验变化。"
related: ["trauma", "attachment-style"]
pubDate: 2026-06-07
tags: ["依恋", "创伤"]
sourceRefs:
...
混乱型依恋常表现为靠近和害怕并存、行为无组织、冻结、突然切换或难以形成稳定求助策略。它常与惊吓性照护、创伤和严重关系不一致有关。
...
它帮助读者理解某些关系反应为什么看似矛盾：个体不是不想亲近，而是亲近本身也触发恐惧。
