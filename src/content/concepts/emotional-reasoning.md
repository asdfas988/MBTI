---
title: "情绪化推理"
description: "因为我感觉如此，所以我推断事实必定如此。它多用于心理治疗中的评估、干预或会谈技术，需要根据个案目标和安全性调整。"
plainDefinition: "因为我感觉如此，所以我推断事实必定如此。"
group: "心理治疗与评估"
...
related: ["cognitive-distortion", "psychic-equivalence", "reality-testing", "anxiety"]
pubDate: 2026-06-08
tags: ["认知歪曲", "情绪", "事实检验"]
sourceRefs:
...
情绪化推理（Emotional Reasoning）指因为我感觉如此，所以我推断事实必定如此。

## 概念边界

情绪化推理多用于心理治疗或个案评估语境，重点是帮助来访者更清楚地观察想法、情绪、行为和关系循环。它不是万能技巧，也不应脱离个案目标、安全性和治疗关系机械使用。

## 为什么重要

它重要是因为很多痛苦并不是靠“想明白”就会改变，而需要把问题拆成可观察、可练习、可反馈的步骤。情绪化推理能让治疗从抽象解释走向具体改变。
...
情绪化推理在人格动力中可以成为新的自我调节经验。它让人不只解释自己为什么痛苦，也开始学习怎样在关系、情绪和行动中拥有更多选择。
