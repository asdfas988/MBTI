---
title: "核查事实"
description: "把事实和脑中的解释分开看。它多用于心理治疗中的评估、干预或会谈技术，需要根据个案目标和安全性调整。"
plainDefinition: "把事实和脑中的解释分开看。"
group: "心理治疗与评估"
english: "Check the Facts"
aliases: ["检查事实"]
domains: ["DBT", "认知调节"]
level: "基础"
clinicalBoundary: "本站把它作为心理治疗与评估概念使用。具体干预需要结合个案目标、风险、文化背景和治疗关系；它不能替代专业诊断或治疗计划。"
related: ["cognitive-distortion", "emotion-regulation-skills", "reality-testing", "mind-reading"]
pubDate: 2026-06-08
tags: ["DBT", "事实核查", "情绪"]
sourceRefs:
...
核查事实（Check the Facts）指把事实和脑中的解释分开看。

## 概念边界

核查事实多用于心理治疗或个案评估语境，重点是帮助来访者更清楚地观察想法、情绪、行为和关系循环。它不是万能技巧，也不应脱离个案目标、安全性和治疗关系机械使用。

## 为什么重要

它重要是因为很多痛苦并不是靠“想明白”就会改变，而需要把问题拆成可观察、可练习、可反馈的步骤。核查事实能让治疗从抽象解释走向具体改变。
...
核查事实在人格动力中可以成为新的自我调节经验。它让人不只解释自己为什么痛苦，也开始学习怎样在关系、情绪和行动中拥有更多选择。
